...
Данные_1 (основной файл (434 МБ), в котором представлены данные с hh.ru): [dst-3.0_16_1_hh_database.CSV](https://drive.google.com/file/d/1wM8oW5eKFQ_VufP4EVhzcSEOTnJoT1io/view?usp=sharing) <br>
Данные_2 (дополнительный файл (193 КБ), в котором представлены данные по курсу валют): [ExchangeRates.CSV](https://drive.google.com/file/d/1JQ8BWBP4bsjMV9hVeKBoVQ8r1OwmCBKL/view?usp=sharing) <br>
<br>
